# 1. BMI Calculator:
# Create a Body Mass Index (BMI) calculator program. Prompt the user to enter their weight (in
# kilograms) and height (in meters), then calculate and print their BMI. Additionally, provide a message indicating
# whether they are underweight, normal weight, overweight, or obese based on the calculated BMI.
...
# 2. Simple Calculator
# Write a program to build a simple calculator that can perform addition, subtraction,
